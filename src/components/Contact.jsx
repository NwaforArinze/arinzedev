      ...
      <div className="container">
        ...
        <div className="contact-content">
          ...
          >
            ...
            <p>
              Feel free to reach out if you're looking for a WordPress developer
            ...
            <div className="social-links">
              <a
                href="https://linkedin.com/in/arinzechukwu-nwafor-b39087293"
                target="_blank"
              ...
              <a
                href="https://github.com/NwaforArinze"
                target="_blank"
                rel="noopener noreferrer"
                className="social-link"
              >
