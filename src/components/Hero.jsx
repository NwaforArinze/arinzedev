      ...
      <div className="container hero-container" data-aos="fade-up">
        <div className="hero-content">
          <div className="badge">
            ...
            <span>Frontend, WordPress & Webflow Developer</span>
          </div>
          <h1 className="hero-title">
            Arinzechukwu <span>Chidera</span> Nwafor
          </h1>
          <p className="hero-description">
            Detail-oriented developer specializing in building responsive and
            user-centric WordPress, Webflow and React websites.
          </p>

          <div className="hero-cta">
            <a href="/Arinzechukwu_Chidera_Nwafor_CV.pdf" download>
              <button className="btn btn-primary">
                Download CV <FaDownload className="icon-spacing" />
              </button>
            </a>
            <a href="https://wa.me/2348135496550" target="_blank">
              <button className="btn btn-secondary">
                Contact Me <FaPaperPlane className="icon-spacing" />
              </button>
            </a>
          </div>
